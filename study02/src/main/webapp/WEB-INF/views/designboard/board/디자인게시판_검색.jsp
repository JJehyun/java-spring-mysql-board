...
<div id="test0011">
            <div id="sidebar" >
              ...
              <div class="sidebar-menus">
                ...
                <div id="black_container_main" style="display:flex; z-index:-99;">
                  <div style="z-index:-99">
                  <div class="_right_outer-container" style="z-index:-99">
					...
					<form action="${search}" Method="GET">
                      ...
                      <div style="z-index:-99">
                            <table id="right_table_main" style="z-index:-99;">
                                <thead style="z-index:-99;" style="z-index:-99">
                                    <tr style="z-index:-99;" style="z-index:-99">
                                        <th>작성자</th>
                                ...
                                <tbody id="middle_tbody" style="z-index:-99">
                                <c:forEach items="${searchtext}" var="VVV">                                
                                    <tr style="z-index:-99">
...
<c:choose> 
	<c:when test="${moneyyy eq 0}">
		...
		<li class="pageNumber"><a href="http://localhost:8080/control/login/check/design/search?paging=${cnt}&q=${usertext}">${cnt }</a></li>
		</c:forEach>
	<li><a href="http://localhost:8080/control/login/check/design/search?paging=${countP}&q=${usertext}" class="next">Next ></a></li>
	</c:when> 
	<c:when test="${newpaging eq totalpage}">
		<li><a href="http://localhost:8080/control/login/check/design/search?paging=${countM}&q=${usertext}" class="prev">< Prev</a></li> <li>마지막 페이지 입니다.</li>
	</c:when> 
	<c:otherwise>
	<li><a href="http://localhost:8080/control/login/check/design/search?paging=${countM}&q=${usertext}" class="prev">< Prev</a></li>
